...
const Footer = () => {
  ...
  <a
    ...
    className="text-gray-500 hover:text-pool-primary"
    aria-label="LinkedIn"
  >
    <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
      <path d="M19 0h-14c-2.76 0-5 2.24-5 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-11.75 20h-3v-10h3v10zm-1.5-11.4c-.97 0-1.75-.79-1.75-1.75s.78-1.75 1.75-1.75 1.75.79 1.75 1.75-.78 1.75-1.75 1.75zm13.25 11.4h-3v-5.5c0-1.38-.03-3.15-1.92-3.15-1.92 0-2.22 1.5-2.22 3.05v5.6h-3v-10h2.88v1.35h.04c.4-.75 1.38-1.54 2.84-1.54 3.04 0 3.6 2 3.6 4.59v5.6z" />
    </svg>
  </a>
</div>

              <a href="https://www.instagram.com/poolpassuk/" className="text-gray-500 hover:text-pool-primary" aria-label="Instagram">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="#" className="text-gray-500 hover:text-pool-primary" aria-label="Twitter">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <p className="mt-8 text-center text-sm text-gray-500">
            © {new Date().getFullYear()} PoolPass. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
